...
ADMIN_IDS = [int(x) for x in os.getenv("7091794658", "").split(",") if x.strip()]

# UPI Configuration
UPI_ID = os.getenv("surojseller@fam", "your-upi@bank")
UPI_NAME = os.getenv("SANDIP BERA", "Account Store")
